    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="card event pt-5">
                    <img src="img/film/F-05.png" class="card-img-top" alt="bora bora">
                    <div class="card-body">
                        <h3 class="card-title">Bora Bora (2011)</h3>
                        <p class="card-text">Vi starter med <span class="fw-bold">filmvisning efterfulgt af Meet n' Greet</span> med instruktør <a href="https://da.wikipedia.org/wiki/Hans_Fabian_Wullenweber">Hans Fabian Wullenweber</a></p>
                        <p class="card-text">Vilma Film Festival præsenterer stolt "Bora Bora" - en dansk film om livets uforudsigelige rejse, der vil tage dig med på en følelsesladet tur fyldt med kærlighed, tab og venskab.
                        </p>
                        <p class="card-text"> Glæd dig til at se skuespillerne Peter Plaugborg, Benjamin Wandschneider, og Josephine Park i denne rørende fortælling.
                        </p>
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="card event pt-3">
                    ...
                    <div class="card-body">
                        <h3 class="card-title">Bølle Bob (1998)</h3>
                        <p class="card-text fw-bold">Outdoor Film Show på Schweizerpladsen!</p>
                        <p class="card-text">Tænd op for spændingen og hop med på en
                            uforglemmelig filmoplevelse under stjernerne!</p>
